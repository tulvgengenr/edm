...
torchrun --standalone --nproc_per_node=$n_gpu edm/train.py  \
        ...
        # --resume=/sfm/sfmexpresults/junzhe/psm/edm_test/transfer_with_ism_v0/00000-cifar10-32x32-cond-ddpmpp-edm_ism-gpus8-batch512-fp32/training-state-025088.pt
